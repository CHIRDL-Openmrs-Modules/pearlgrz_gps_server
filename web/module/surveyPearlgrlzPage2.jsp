...
<body>
	...
	<c:when test="${redirectto} == 'redirectto'">
		COMPLETE.
	<!-- 
		<form name="output" action="surveyPearlgrlzPage2.form" method="get">
	 -->
    ...
    <form name="pearlgrlzSelfSubmitForm"  action="pearlgrlzForm.form" method="post">
     -->
     <!-- 
		<form name="input" action="surveyPearlgrlzPage2.form" method="get">
	 -->
		<form name="input" action="surveyPearlgrlzPage2.form" method="get">
			...
			<c:choose>
				<c:when test="${formName} != 'surveyPearlgrlzPage2'">
