...
/**
 * This controller backs the /web/module/surveyAlcohol.jsp page. This controller is tied to that
 * jsp page in the /metadata/moduleApplicationContext.xml file
 */
public class AlcoholFormController extends SimpleFormController {
	...
	protected ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response, Object object,
		...
		return new ModelAndView(new RedirectView("surveyPage1.form"), map);
	}
