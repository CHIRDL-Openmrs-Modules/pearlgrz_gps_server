/********************************************************************
 Translated from - timesSmokedCigarettes.mlm on Thu Mar 18 14:57:17 EDT 2010
...
public class timesSmokedCigarettes implements Rule, DssRule{
	...
	public String getDate(){
		return "2010-03-01T16:12:57-0500";
	}
	...
	public String getPurpose(){
		return "Identify smoking cigarettes related problems. , , singleSelect , , frequencyOptions";
	}
	...
	public String getData(){
		return "read read read If read endif";
	}
...
return false;
	...
	private boolean evaluate_logic(Map<String, Object> parameters) throws LogicException {
		...
		if((!Input1.isNull()&&Input1.toString().equalsIgnoreCase("true"))){
				varLen = "Number of times smoking cigarettes since last survey".length();
				value=userVarMap.get("Number of times smoking cigarettes since last survey");
				if(value != null){
					parameters.put("param1",value);
				}
				// It must be a result value or date
				else if("Number of times smoking cigarettes since last survey".endsWith("_value"))
				{
					variable = "Number of times smoking cigarettes since last survey".substring(0, varLen-6); // -6 for _value
					if (resultLookup.get(variable) != null){
						value = resultLookup.get(variable).toString();
					}
				}
				else if("Number of times smoking cigarettes since last survey".endsWith("_date"))
				{
					variable = "Number of times smoking cigarettes since last survey".substring(0, varLen-5); // -5 for _date
					if (resultLookup.get(variable) != null){
				...
				{
					if (resultLookup.get("Number of times smoking cigarettes since last survey") != null){
						value = resultLookup.get("Number of times smoking cigarettes since last survey").toString();
					}
				}
				if(value != null){
					parameters.put("param1",value);
				...
				{
					parameters.put("param1","Number of times smoking cigarettes since last survey");
				}
	...
	public void initAction() {
		...
		actions.add("Number of times smoked cigarettes since last survey?");
	}
