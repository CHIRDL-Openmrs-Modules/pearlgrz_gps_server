/********************************************************************
 Translated from - doNotWantToAnswer.mlm on Thu Mar 18 11:22:22 EDT 2010

 Title:  Do not want to answer Question
 Filename:  doNotWantToAnswer.mlm
 Version: 1.0
 Institution:  Indiana University School of Medicine
 Author:  Jun Wang
 Specialist:  Software Engineer
 Date: 2010-01-29T10:12:57-0500
 Validation : research
...
public class doNotWantToAnswer implements Rule, DssRule{
	...
	public String getDate(){
		return "2010-01-29T10:12:57-0500";
	}
	...
	public String getTitle(){
		return "Do not want to answer Question";
	}
...
return false;
	...
	private boolean evaluate_logic(Map<String, Object> parameters) throws LogicException {
		...
		if((!Box1.isNull()&&Box1.toString().equalsIgnoreCase("true"))){
				varLen = "Do not want to answer".length();
				value=userVarMap.get("Do not want to answer");
				if(value != null){
					parameters.put("param1",value);
				}
				// It must be a result value or date
				else if("Do not want to answer".endsWith("_value"))
				{
					variable = "Do not want to answer".substring(0, varLen-6); // -6 for _value
					if (resultLookup.get(variable) != null){
						value = resultLookup.get(variable).toString();
					}
				}
				else if("Do not want to answer".endsWith("_date"))
				{
					variable = "Do not want to answer".substring(0, varLen-5); // -5 for _date
					if (resultLookup.get(variable) != null){
				...
				{
					if (resultLookup.get("Do not want to answer") != null){
						value = resultLookup.get("Do not want to answer").toString();
					}
				}
				if(value != null){
					parameters.put("param1",value);
				...
				{
					parameters.put("param1","Do not want to answer");
				}
				varLen = "Yes".length();
	...
	public void initAction() {
		...
		actions.add("Do not want to answer these questions?");
		actions.add("No quiero responder a estas preguntas?@Spanish");
	}
