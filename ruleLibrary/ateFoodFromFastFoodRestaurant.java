/********************************************************************
 Translated from - ateFoodFromFastFoodRestaurant.mlm on Thu Mar 18 11:22:24 EDT 2010
...
public class ateFoodFromFastFoodRestaurant implements Rule, DssRule{
	...
	public String getTitle(){
		return "fast foodrelated Question";
	}
...
return false;
	...
	private boolean evaluate_logic(Map<String, Object> parameters) throws LogicException {
		...
		if((!Box1.isNull()&&Box1.toString().equalsIgnoreCase("true"))){
				varLen = "Ate food from a fast food restaurant".length();
				value=userVarMap.get("Ate food from a fast food restaurant");
				if(value != null){
					parameters.put("param1",value);
				}
				// It must be a result value or date
				else if("Ate food from a fast food restaurant".endsWith("_value"))
				{
					variable = "Ate food from a fast food restaurant".substring(0, varLen-6); // -6 for _value
					if (resultLookup.get(variable) != null){
						value = resultLookup.get(variable).toString();
					}
				}
				else if("Ate food from a fast food restaurant".endsWith("_date"))
				{
					variable = "Ate food from a fast food restaurant".substring(0, varLen-5); // -5 for _date
					if (resultLookup.get(variable) != null){
				...
				{
					if (resultLookup.get("Ate food from a fast food restaurant") != null){
						value = resultLookup.get("Ate food from a fast food restaurant").toString();
					}
				}
				if(value != null){
					parameters.put("param1",value);
				...
				{
					parameters.put("param1","Ate food from a fast food restaurant");
				}
				varLen = "Yes".length();
	...
	public void initAction() {
		...
		actions.add("Ate food from a fast food restaurant?");
	}
