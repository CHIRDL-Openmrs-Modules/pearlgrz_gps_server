/********************************************************************
 Translated from - excercisedMoreThanThirtyMinutes.mlm on Thu Mar 18 11:22:26 EDT 2010

 Title:  excercise related Question
 Filename:  excercisedMoreThanThirtyMinutes.mlm
 Version: 1.0
...
public class excercisedMoreThanThirtyMinutes implements Rule, DssRule{
	...
	public String getDate(){
		return "2010-01-29T11:21:35-0500";
	}
	...
	public String getTitle(){
		return "excercise related Question";
	}
...
return false;
	...
	private boolean evaluate_logic(Map<String, Object> parameters) throws LogicException {
		...
		if((!Box1.isNull()&&Box1.toString().equalsIgnoreCase("true"))){
				varLen = "Exercised for at least 30 minutes".length();
				value=userVarMap.get("Exercised for at least 30 minutes");
				if(value != null){
					parameters.put("param1",value);
				}
				// It must be a result value or date
				else if("Exercised for at least 30 minutes".endsWith("_value"))
				{
					variable = "Exercised for at least 30 minutes".substring(0, varLen-6); // -6 for _value
					if (resultLookup.get(variable) != null){
						value = resultLookup.get(variable).toString();
					}
				}
				else if("Exercised for at least 30 minutes".endsWith("_date"))
				{
					variable = "Exercised for at least 30 minutes".substring(0, varLen-5); // -5 for _date
					if (resultLookup.get(variable) != null){
				...
				{
					if (resultLookup.get("Exercised for at least 30 minutes") != null){
						value = resultLookup.get("Exercised for at least 30 minutes").toString();
					}
				}
				if(value != null){
					parameters.put("param1",value);
				...
				{
					parameters.put("param1","Exercised for at least 30 minutes");
				}
				varLen = "Yes".length();
	...
	public void initAction() {
		...
		actions.add("Exercised for at least 30 minutes?");
	}
