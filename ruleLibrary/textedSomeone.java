/********************************************************************
 Translated from - textedSomeone.mlm on Thu Mar 18 11:22:21 EDT 2010

 Title:  texted someone Question
 Filename:  textedSomeone.mlm
 Version: 1.0
 ...
 Validation : research
 Purpose:  Identify text messaging related problems.
 Explanation: 
 Keywords: 
 Citations: 
 Links: 
...
public class textedSomeone implements Rule, DssRule{
	...
	public String getPurpose(){
		return "Identify text messaging related problems.";
	}
	...
	public String getTitle(){
		return "texted someone Question";
	}
...
return false;
	...
	private boolean evaluate_logic(Map<String, Object> parameters) throws LogicException {
		...
		if((!Box1.isNull()&&Box1.toString().equalsIgnoreCase("true"))){
				varLen = "Texted someone".length();
				value=userVarMap.get("Texted someone");
				if(value != null){
					parameters.put("param1",value);
				}
				// It must be a result value or date
				else if("Texted someone".endsWith("_value"))
				{
					variable = "Texted someone".substring(0, varLen-6); // -6 for _value
					if (resultLookup.get(variable) != null){
						value = resultLookup.get(variable).toString();
					}
				}
				else if("Texted someone".endsWith("_date"))
				{
					variable = "Texted someone".substring(0, varLen-5); // -5 for _date
					if (resultLookup.get(variable) != null){
				...
				{
					if (resultLookup.get("Texted someone") != null){
						value = resultLookup.get("Texted someone").toString();
					}
				}
				if(value != null){
					parameters.put("param1",value);
				...
				{
					parameters.put("param1","Texted someone");
				}
				varLen = "Yes".length();
	...
	public void initAction() {
		...
		actions.add("Did you text someone?");
		actions.add("¿Sabía usted que alguien de texto?@Spanish");
	}
