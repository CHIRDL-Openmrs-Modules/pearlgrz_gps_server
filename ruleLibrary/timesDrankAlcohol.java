/********************************************************************
 Translated from - timesDrankAlcohol.mlm on Thu Mar 18 14:57:18 EDT 2010

 Title:  alcohol related Question
 Filename:  timesDrankAlcohol.mlm
 Version: 1.0
 ...
 Validation : research
 Purpose:  Identify alcohol related problems. , , singleSelect , , frequencyOptions
 Explanation: 
 Keywords: 
 Citations: 
 Links: 
...
public class timesDrankAlcohol implements Rule, DssRule{
	...
	public String getPurpose(){
		return "Identify alcohol related problems. , , singleSelect , , frequencyOptions";
	}
	...
	public String getTitle(){
		return "alcohol related Question";
	}
...
return false;
	...
	private boolean evaluate_logic(Map<String, Object> parameters) throws LogicException {
		...
		if((!Input1.isNull()&&Input1.toString().equalsIgnoreCase("true"))){
				varLen = "Number of times drinking alcohol since last survey".length();
				value=userVarMap.get("Number of times drinking alcohol since last survey");
				if(value != null){
					parameters.put("param1",value);
				}
				// It must be a result value or date
				else if("Number of times drinking alcohol since last survey".endsWith("_value"))
				{
					variable = "Number of times drinking alcohol since last survey".substring(0, varLen-6); // -6 for _value
					if (resultLookup.get(variable) != null){
						value = resultLookup.get(variable).toString();
					}
				}
				else if("Number of times drinking alcohol since last survey".endsWith("_date"))
				{
					variable = "Number of times drinking alcohol since last survey".substring(0, varLen-5); // -5 for _date
					if (resultLookup.get(variable) != null){
				...
				{
					if (resultLookup.get("Number of times drinking alcohol since last survey") != null){
						value = resultLookup.get("Number of times drinking alcohol since last survey").toString();
					}
				}
				if(value != null){
					parameters.put("param1",value);
				...
				{
					parameters.put("param1","Number of times drinking alcohol since last survey");
				}
	...
	public void initAction() {
		...
		actions.add("Number of times drinking alcohol since last survey?");
	}
