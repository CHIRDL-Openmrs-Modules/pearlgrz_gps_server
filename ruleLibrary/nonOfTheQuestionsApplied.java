/********************************************************************
 Translated from - nonOfTheQuestionsApplied.mlm on Thu Mar 18 11:17:17 EDT 2010

 Title:  none of the questions applied
 Filename:  nonOfTheQuestionsApplied.mlm
 Version: 1.0
 ...
 Validation : research
 Purpose:  Identify survey questions response related problems.
 Explanation: 
 Keywords: 
 Citations: 
 Links: 
...
public class nonOfTheQuestionsApplied implements Rule, DssRule{
	...
	public String getPurpose(){
		return "Identify survey questions response related problems.";
	}
	...
	public String getTitle(){
		return "none of the questions applied";
	}
...
return false;
	...
	private boolean evaluate_logic(Map<String, Object> parameters) throws LogicException {
		...
		if((!Box1.isNull()&&Box1.toString().equalsIgnoreCase("true"))){
				varLen = "None of the questions applied".length();
				value=userVarMap.get("None of the questions applied");
				if(value != null){
					parameters.put("param1",value);
				}
				// It must be a result value or date
				else if("None of the questions applied".endsWith("_value"))
				{
					variable = "None of the questions applied".substring(0, varLen-6); // -6 for _value
					if (resultLookup.get(variable) != null){
						value = resultLookup.get(variable).toString();
					}
				}
				else if("None of the questions applied".endsWith("_date"))
				{
					variable = "None of the questions applied".substring(0, varLen-5); // -5 for _date
					if (resultLookup.get(variable) != null){
				...
				{
					if (resultLookup.get("None of the questions applied") != null){
						value = resultLookup.get("None of the questions applied").toString();
					}
				}
				if(value != null){
					parameters.put("param1",value);
				...
				{
					parameters.put("param1","None of the questions applied");
				}
				varLen = "Yes".length();
	...
	public void initAction() {
		...
		actions.add("None of the questions applied?");
		actions.add("Ninguna de las preguntas aplicadas?@Spanish");
	}
